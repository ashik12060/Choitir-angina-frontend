...
//   return (
//     <div className="container mx-auto p-6 md:p-10 bg-gray-50 shadow-lg rounded-lg">
...
//             <button
//               type="submit"
//               className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg shadow-md transition-transform transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-blue-300"
//             >
//               Submit
//             </button>
//           </div>
